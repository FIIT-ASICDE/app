// pages/block-diagram/components/PropertiesPanel/PropertiesPanel.tsx
import React, { useState, useEffect } from "react";
import { useHotkeys } from "@/app/block-diagram/hooks/useHotkeys";
...
import {JointJSMultiplexer} from "@/app/block-diagram/components/Shapes/complexLogic/JointJSMultiplexer";
import {JointJSAnd} from "@/app/block-diagram/components/Shapes/gates/JointJSAnd";
import {And} from "@/app/block-diagram/components/Shapes/classes/and";
import {JointJSOr} from "@/app/block-diagram/components/Shapes/gates/JointJSOr";
import {Or} from "@/app/block-diagram/components/Shapes/classes/or";
import {JointJSXor} from "@/app/block-diagram/components/Shapes/gates/JointJSXor";
import {Xor} from "@/app/block-diagram/components/Shapes/classes/xor";
import {JointJSXnor} from "@/app/block-diagram/components/Shapes/gates/JointJSXnor";
import {Xnor} from "@/app/block-diagram/components/Shapes/classes/xnor";
import {JointJSNand} from "@/app/block-diagram/components/Shapes/gates/JointJSNand";
import {Nand} from "@/app/block-diagram/components/Shapes/classes/nand";
import {JointJSNor} from "@/app/block-diagram/components/Shapes/gates/JointJSNor";
import {Nor} from "@/app/block-diagram/components/Shapes/classes/nor";
import {JointJSNot} from "@/app/block-diagram/components/Shapes/gates/JointJSNot";
...
import {JointJSRegister} from "@/app/block-diagram/components/Shapes/memory/JointJSRegister";
import {Register} from "@/app/block-diagram/components/Shapes/classes/register";
import {JointJSSRam} from "@/app/block-diagram/components/Shapes/memory/JointJSSRam";
import {Sram} from "@/app/block-diagram/components/Shapes/classes/sram";
import {JointJSCombiner} from "@/app/block-diagram/components/Shapes/bitOperations/JointJSCombiner";
import {Combiner} from "@/app/block-diagram/components/Shapes/classes/combiner";
import {JointJSSplitter} from "@/app/block-diagram/components/Shapes/bitOperations/JointJSSplitter";
...
import {JointJSAlu} from "@/app/block-diagram/components/Shapes/complexLogic/JointJSAlu";
import {Alu} from "@/app/block-diagram/components/Shapes/classes/alu";
import {JointJSComparator} from "@/app/block-diagram/components/Shapes/complexLogic/JointJSComparator";
import {Comparator} from "@/app/block-diagram/components/Shapes/classes/comparator";
import {JointJSDecoder} from "@/app/block-diagram/components/Shapes/complexLogic/JointJSDecoder";
import {Decoder} from "@/app/block-diagram/components/Shapes/classes/decoder";
import {JointJSEncoder} from "@/app/block-diagram/components/Shapes/complexLogic/JointJSEncoder";
...
import { parseVHDLTextFromRegex } from "@/app/block-diagram/utils/DiagramGeneration/VHDL/parseVHDLTextFromRegex";
import { parseSystemVerilogTextFromRegex } from "@/app/block-diagram/utils/DiagramGeneration/SystemVerilog/parseSystemVerilogTextFromRegex";
import { parseSystemVerilogModules } from "@/app/block-diagram/utils/DiagramGeneration/SystemVerilog/parseSystemVerilogModules";
import { parseVhdlEntities } from "@/app/block-diagram/utils/DiagramGeneration/VHDL/parseVHDLEntities";
