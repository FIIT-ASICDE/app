                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full border-collapse">
                                ...
                                {commits.map((commit: GitCommit, index: number) => (
                                    <tr key={index + commit.hash} className="border border-accent">
                                        <td className="whitespace-nowrap p-2 text-sm truncate max-w-lg">
                                            {commit.message} looooooooooooo ng mess age fsd fwe fwe
                                        </td>
                                        <td className="whitespace-nowrap p-2 text-sm text-right text-muted-foreground">
                                            {getTimeDeltaString(commit.authorDate)}
                                        </td>
                                    </tr>
                                ))}
                                </tbody>
