...
import { RepositoryCardDisplayType, RepositoryVisibility } from "@/lib/types/repository";
                    ...
                    <div className="flex flex-col gap-y-3">
                        <div className="flex flex-row gap-x-3">
                            ...
                            <Link href={"/" + ownerName + "/" + name}>
                                <Button
                                    variant="link"
                                    className="m-0 p-0 text-base font-semibold leading-none tracking-tight truncate overflow-hidden whitespace-nowrap max-w-full"
                                >
